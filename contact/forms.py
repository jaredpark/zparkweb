...
class ContactForm(forms.Form):
	...
	phone = forms.CharField(label='', required=False, widget=forms.TextInput(attrs={'placeholder': 'Your phone number', 'class': 'phone_field',}),
		error_messages={'invalid': 'Please enter numbers only'})
