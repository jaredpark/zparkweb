...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('myBlog_post', 'content', self.gf('djangocms_text_ckeditor.fields.HTMLField')())

    def backwards(self, orm):

        # Changing field 'Post.content'
        db.alter_column('myBlog_post', 'content', self.gf('django.db.models.fields.TextField')())
