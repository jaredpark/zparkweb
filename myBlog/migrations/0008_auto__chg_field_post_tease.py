...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Post.tease'
        db.alter_column('myBlog_post', 'tease', self.gf('django.db.models.fields.CharField')(null=True, max_length=100))
    ...
    models = {
        ...
        'myBlog.post': {
            ...
            'tease': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
