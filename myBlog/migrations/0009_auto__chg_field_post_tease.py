...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.tease'
        db.alter_column('myBlog_post', 'tease', self.gf('djangocms_text_ckeditor.fields.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'Post.tease'
        db.alter_column('myBlog_post', 'tease', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'myBlog.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True', 'null': 'True'}),
