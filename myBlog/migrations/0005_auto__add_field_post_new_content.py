...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.new_content'
        db.add_column('myBlog_post', 'new_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['cms.Placeholder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.new_content'
        db.delete_column('myBlog_post', 'new_content_id')
    ...
    models = {
        ...
        'myBlog.post': {
            ...
            'new_content': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['cms.Placeholder']"}),
