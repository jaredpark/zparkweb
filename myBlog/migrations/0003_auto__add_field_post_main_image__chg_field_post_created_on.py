...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.main_image'
        db.add_column('myBlog_post', 'main_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True, null=True),
                      keep_default=False)


        # Changing field 'Post.created_on'
        db.alter_column('myBlog_post', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Post.main_image'
        db.delete_column('myBlog_post', 'main_image')


        # Changing field 'Post.created_on'
        db.alter_column('myBlog_post', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
