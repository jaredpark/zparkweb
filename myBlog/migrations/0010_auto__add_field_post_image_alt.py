...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.image_alt'
        db.add_column('myBlog_post', 'image_alt',
                      self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.image_alt'
        db.delete_column('myBlog_post', 'image_alt')
    ...
    models = {
        ...
        'myBlog.post': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['cms.Placeholder']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_alt': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'main_image': ('django.db.models.fields.files.ImageField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
